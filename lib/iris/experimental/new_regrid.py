...
class BackprojectRegridder(object):
    ...
    def __init__(self, src_grid_cube, target_grid_cube, weights):
        ...
        * weights:
        ...
        self.src_grid, self.x_points, self. y_points = BackprojectRegridder.cube_grid(self._src_cube)
        ...
        * grid_cube:
        ...
        def _regrid_indices(t_grid):
            ...
            for i ,square in enumerate(squares):
                ...
                indices, checkcells = self.get_points_in_square(square)
                ...
                temp_point = np.asarray((self.x_points[checkcells[:,1]], self.y_points[checkcells[:,0]]))
    ...
    def intersected_and_safe_inds(self, square):
        ...
        # by adding cells in each column where
